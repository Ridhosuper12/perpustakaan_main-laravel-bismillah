    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('.btn-detail').click(function(){
                ...
                let id = $(this).data('id');
                $.ajax({
                    url : `http://127.0.0.1:8000/anggota/${id}`,
                    method:'GET',
            ...
            $('.btn-edit').click(function(){
                ...
                let id = $(this).data('id');
                $.ajax({
                    url : `http://127.0.0.1:8000/anggota/${id}/edit`,
                    method : 'GET',
                    success: function(data){
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\perpustakaan_laravel-main-bismillah\resources\views/anggota/index.blade.php ENDPATH**/ ?>