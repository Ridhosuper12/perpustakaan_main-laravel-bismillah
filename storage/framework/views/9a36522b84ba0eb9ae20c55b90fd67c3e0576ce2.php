...
<div class="row">
    ...
    <div class="col-md-6 mt-4 mb-3 d-flex justify-content-end">
        ...
        <form action="<?php echo e(route('transaksi.search')); ?>" method="get" class="navbar-search navbar-search-light form-inline mr-sm-3 " id="navbar-search-main">
            ...
            <input type="text" placeholder="masukkan judul buku" class="form-control bg-white <?php $__errorArgs = ['q'];
                ...
                <table class="table align-items-center table-flush">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th scope="col" class="sort" data-sort="Kode Transaksi">Judul</th>
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <th scope="row">
                                <div class="media align-items-center">
                                    <div class="media-body">
                                        <span class="name mb-0 text-sm"><?php echo e($item->buku->judul); ?></span>
                                    </div>
                                </div>
                            </th>
                            ...
                            <td class="text-right">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        ...
                                        <form action="<?php echo e(route('transaksi.destroy', $item->id)); ?>" method="post" id="delete<?php echo e($item->id); ?>">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('delete'); ?>
                                            <button class="dropdown-item" type="button" onclick="deleteTransaksi(<?php echo e($item->id); ?>)">Hapus</button>
                                        </form>
                                        <?php endif; ?>
...
<script>
    ...
    $('.btn-edit').click(function() {
        let id = $(this).data('id');
        $.ajax({
            url: `http://127.0.0.1:8000/transaksi/${id}/edit`,
            method: 'GET',
    ...
    $('.btn-detail').click(function() {
        let id = $(this).data('id');
        $.ajax({
            url: `http://127.0.0.1:8000/transaksi/${id}`,
            method: 'GET',
            success: function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\perpustakaan_laravel-main-bismillah\resources\views/transaksi/index.blade.php ENDPATH**/ ?>