...
<head>
    ...
    <!-- Favicon logo masuk login-->
    <link rel="icon" href="<?php echo e(asset('template')); ?>/img/brand/download (1).ico" type="image/png">
            ...
            <div class="scrollbar-inner">
                ...
                <div class="sidenav-header  align-items-center">
                    <a class="navbar-brand" href="javascript:void(0)">
                        <img src="<?php echo e(asset('template')); ?>/img/brand/logo.png" style="width:50px;height:70px;" class="navbar-brand-img" alt="...">
                        <h2 class="h2 text-black mb-0">E-PERPUSTAKAAN</h2>
                    </a> 
                </div>
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                       ...
                       <li class="nav-item">
                        ...
                        <?php if(Auth::user()->level == 'admin'): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->is('cetak-pertanggal-form') ? 'active' : ''); ?>"
                                href="<?php echo e(route('cetak-pertanggal-form')); ?>">
                                <i class="ni ni-single-copy-04 text-cyan"></i>
                                <span class="nav-link-text">Laporan Pertanggal</span>
                            </a>
                        </li>
                        <?php endif; ?>
                        <?php endif; ?>
    ...
    <div class="main-content" id="panel">
        ...
        <nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom">
            <div class="container-fluid">
                ...
                <marquee >
          <h2><strong> <a href="https://staimaarifjambi.ac.id/" style="color: white;">SISTEM INFORMASI PERPUSTAKAAN STAI MA'ARIF JAMBI</a> </strong></h2>
           </marquee>
...
<?php /**PATH C:\xampp\htdocs\perpustakaan_laravel-main-bismillah\resources\views/layouts/master.blade.php ENDPATH**/ ?>