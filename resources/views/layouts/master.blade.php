...
<head>
    ...
    <link rel="icon" href="{{ asset('template') }}/img/brand/download (1).ico" type="image/png">
            ...
            <div class="scrollbar-inner">
                ...
                <div class="sidenav-header  align-items-center">
                    <a class="navbar-brand" href="javascript:void(0)">
                        <img src="{{ asset('template') }}/img/brand/logo.png" style="width:50px;height:70px;" class="navbar-brand-img" alt="...">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                       ...
                       <li class="nav-item">
                        ...
                        @if(Auth::user()->level == 'admin')
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('cetak-pertanggal-form') ? 'active' : '' }}"
                                href="{{ route('cetak-pertanggal-form') }}">
                                <i class="ni ni-single-copy-04 text-cyan"></i>
