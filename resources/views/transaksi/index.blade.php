...
<div class="row">
    ...
    <div class="col-md-6 mt-4 mb-3 d-flex justify-content-end">
        ...
        <form action="{{ route('transaksi.search') }}" method="get" class="navbar-search navbar-search-light form-inline mr-sm-3 " id="navbar-search-main">
            ...
            <input type="text" placeholder="masukkan judul buku" class="form-control bg-white @error('q') is-invalid @enderror" name="q" autocomplete="off" autofocus>
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <th scope="row">
                                <div class="media align-items-center">
                                    <div class="media-body">
                                        <span class="name mb-0 text-sm">{{ $item->buku->judul }}</span>
                                    </div>
                                </div>
                            </th>
                            ...
                            <td class="text-right">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        ...
                                        <form action="{{ route('transaksi.destroy', $item->id) }}" method="post" id="delete{{ $item->id }}">
                                            @csrf
                                            @method('delete')
                                            <button class="dropdown-item" type="button" onclick="deleteTransaksi({{ $item->id}})">Hapus</button>
                                        </form>
                                        @endif
